...
public class JSFormatSupport extends ExtFormatSupport {
                ...
                switch (t.getTokenID().getNumericID()) {
                    ...
                    case JSTokenContext.RBRACE_ID:
                        ...
                        if (!isArrayInitializationBraceBlock(t, null)) {
                            ...
                            t = findMatchingToken(t, null, JSTokenContext.LBRACE, true);
                        }
                        break;

                    case JSTokenContext.COLON_ID:
                        TokenItem tt = findAnyToken(t, null, new TokenID[]{JSTokenContext.CASE, JSTokenContext.DEFAULT, JSTokenContext.FOR, JSTokenContext.QUESTION, JSTokenContext.ASSERT}, t.getTokenContextPath(), true);
                        if (tt != null) {
            ...
            switch (t.getTokenID().getNumericID()) {
                case JSTokenContext.SEMICOLON_ID: // ';' found
                    ...
                    switch (scss.getTokenID().getNumericID()) {
                        ...
                        case JSTokenContext.IF_ID:
                        case JSTokenContext.WHILE_ID:
                        case JSTokenContext.SYNCHRONIZED_ID:
        ...
        if (indent < 0) { // if not yet resolved
            ...
            if (t != null) { // valid important token
                ...
                switch (t.getTokenID().getNumericID()) {
                    ...
                    case JSTokenContext.COLON_ID:
                        TokenItem ttt = findAnyToken(t, null, new TokenID[]{JSTokenContext.CASE, JSTokenContext.DEFAULT, JSTokenContext.FOR, JSTokenContext.QUESTION, JSTokenContext.ASSERT}, t.getTokenContextPath(), true);
                    ...
                    default: {
                        ...
                        if (stmtStart != null) {
                            ...
                            if (t != null && tokenEquals(t, JSTokenContext.COMMA, tokenContextPath)) {
                            ...
                            if (t != null) {
                                ...
                                if (pos != null) {
                                    ...
                                    if (maybeAnno != null && maybeAnno.getTokenID() == JSTokenContext.ANNOTATION) {
                                        indent -= getFormatStatementContinuationIndent();
                                    }
                                }
                            }
                ...
                case JSTokenContext.LBRACE_ID:
                    ...
                    if (depth < 0) {
                        ...
                        return (prev != null && prev.getTokenContextPath() == tokenContextPath
                                && (JSTokenContext.RBRACKET.equals(prev.getTokenID())
                                || JSTokenContext.EQ.equals(prev.getTokenID())));
                    }
                    break;
    ...
    public boolean isEnumComma(TokenItem token) {
        while (token != null && tokenEquals(token, JSTokenContext.COMMA, tokenContextPath)) {
            TokenItem itm = findStatementStart(token);
            if (itm == token)
                break;
            token = itm;
        }
        if (token != null && tokenEquals(token, JSTokenContext.IDENTIFIER, tokenContextPath)) {
            TokenItem itm = findImportantToken(token, null, true);
            if (itm != null && tokenEquals(itm, JSTokenContext.LBRACE, tokenContextPath)) {
                TokenItem startItem = findStatementStart(itm);
                if (startItem != null && findToken(startItem, itm, JSTokenContext.ENUM, tokenContextPath, null, false) != null)
                    return true;
            }
        }
        return false;
