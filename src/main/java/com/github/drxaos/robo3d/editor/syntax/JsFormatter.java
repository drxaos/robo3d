...
public class JSFormatter extends ExtFormatter {
    ...
    public class JavaLayer extends AbstractFormatLayer {
        ...
        private void removeLineBeforeToken(TokenItem token, JSFormatSupport jfs, boolean checkRBraceBefore) {
            ...
            if (checkRBraceBefore) {
                ...
                if (ftpos == null || ftpos.getToken().getTokenID().getNumericID() != JSTokenContext.RBRACE_ID) {
                    return;
                }
            }
         ...
         */
        private void insertNewLineBeforeToken(TokenItem token, JSFormatSupport jfs) {
                ...
                if (token.getTokenContextPath() == jfs.getTokenContextPath()) {
                    switch (token.getTokenID().getNumericID()) {
                        ...
                        case JSTokenContext.CATCH_ID: //catch
                            ...
                            break;
                        case JSTokenContext.FINALLY_ID: //finally
                            if (jfs.getFormatNewlineBeforeBrace()) {
                                ...
                                if (jfs.getFormatNewlineBeforeBrace()) {
                                    ...
                                    if (ftpos != null) {
                                        switch (ftpos.getToken().getTokenID().getNumericID()) {
                                            ...
                                            case JSTokenContext.IDENTIFIER_ID: // public class Hello {
                                            case JSTokenContext.ELSE_ID:
                                            case JSTokenContext.FINALLY_ID:
                            ...
                            if (jfs.getFormatSpaceBeforeParenthesis()) {
                                ...
                                if (prevToken != null &&
                                        (prevToken.getTokenID() == JSTokenContext.IDENTIFIER ||
                                                ...
                                                prevToken.getTokenID() == JSTokenContext.SUPER)) {
                                    if (jfs.canInsertToken(token)) {
                                ...
                                if (prevToken != null && prevToken.getTokenID() == JSTokenContext.WHITESPACE &&
                                    ...
                                    if (prevprevToken != null &&
                                            (prevprevToken.getTokenID() == JSTokenContext.IDENTIFIER ||
                                                    ...
                                                    prevprevToken.getTokenID() == JSTokenContext.SUPER)) {
