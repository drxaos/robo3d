...
/**
* JavaScript token-context defines token-ids and token-categories
* used in JavaScript language.
*
...
public class JSTokenContext extends TokenContext {
    ...
    public static final int VOLATILE_ID = VAR_ID + 1;
    ...
    */
    ...
    private JSTokenContext() {
        super("javascript-"); // NOI18N
