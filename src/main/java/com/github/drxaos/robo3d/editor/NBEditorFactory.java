...
public class NBEditorFactory
{
   ...
   */
  public static void addSyntax( ExtKit anEditorKit, 
    Settings.AbstractInitializer aSettingsInitializer )
  {
   ...
   *  be installed.
   */
  private static void updateKeyBindings( JEditorPane anEditorPane )
  {
    ...
    try
    {
      InputStream inputStream = NBEditorFactory.class.getResourceAsStream("/keybindings.properties");
   ...
   */
  public static JComponent newTextRenderer( ExtKit anEditorKit, JEditorPane anEditorPane )
  {
    initEditorSettings();
